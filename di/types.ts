import type { IMagicLinkRepository, IDeleteAccountTokenRepository, IUserRepository } from '~~/src/application/repositories'
import type { IImageService, IEmailService } from '~~/src/application/services'
